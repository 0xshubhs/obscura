  ...
  const principles = [
    {
      ...
      description: "Bids are encrypted client-side with @zama-fhe/relayer-sdk and submitted as euint64 handles. The contract operates on ciphertexts — no commitment scheme, no reveal step, no leakage.",
      align: "left",
    },
    {
      number: "02",
    ...
    },
    {
      ...
      description: "Zama FHE puts FHE natively in the EVM. Bids are ciphertexts on-chain, computation happens inside FHE, decryption is a permissioned async call. Cryptographic privacy with on-chain enforceability.",
      align: "left",
    },
    {
      number: "04",
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">OBSCURA VALUES</h2>
      </div>
