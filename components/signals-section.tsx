...
const signals = [
  {
    ...
    note: "Every bid is an euint64 ciphertext. @zama-fhe/relayer-sdk encrypts client-side; only handles touch the chain — plaintext amounts never leave your wallet.",
  },
  {
    date: "2026.04.14",
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">WHY OBSCURA</h2>
      </div>
